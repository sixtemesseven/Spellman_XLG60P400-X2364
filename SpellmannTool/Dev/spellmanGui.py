...
class MainWindow(TemplateBaseClass):  
    ...
    def __init__(self):
        ...
        self.ui.connect.setStyleSheet("background-color: rgb(235,1,20)") #Paint Connect Switch red at start
        
        self.show()
        
    def setPort(self):
        if(self.guiXlg.connectPort(self.ui.sPort.value()) is True):
            self.ui.connect.setStyleSheet("background-color: rgb(106,235,43)") #Indicate a connection via Serial
            #Set Qtimer to update gui as soon as port is connected
